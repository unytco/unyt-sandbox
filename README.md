...
This version 0.48.0 release is primarily focused on providing support for a billing process that can enable even very low capacity devices to be able to "get credit for their work."
